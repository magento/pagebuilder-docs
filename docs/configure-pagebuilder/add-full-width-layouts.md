...
![Add a full-width layout Layout](../images/product-full-width.png)
...
To enable full width within your custom themes, you must verify that the appropriate block is not within your page's main wrapper. This implementation will differ on a case-by-case basis, but the above implementations for Luma should give you a good indication on how to approach these.
