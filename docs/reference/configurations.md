...
| `menu_section`      | Menu section or category in the panel menu where your content type is displayed. The default menu sections are Layout, Elements, Media, and Add Content. See [Panel configurations](../customizing/how-to-customize-panel.md) for more details.                                                                                                                                                                                                                                                                                                                                                                                                      |
| `icon`              | CSS class for icon to be displayed within the menu alongside the content types name. See [How to add icons and images](../customizing/how-to-add-icons-images.md) for more guidance.                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| `additional_data` | Allows you to specify additional data for the component. See [additional configurations](../customizing/how-to-add-additional-configurations.md) for more information.                                                                                                                                                                                                      |
...
For more information on how to customise the menu sections and the left panel please see: [How to customize the panel](../customizing/how-to-customize-panel.md).
