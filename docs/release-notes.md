...
-  {:.new}**Documentation on adding new Appearances**<br/>
   Everything you need to know about [adding appearances](https://devdocs.magento.com/page-builder/docs/customizing/how-to-add-appearance.html) for existing or custom content types.
