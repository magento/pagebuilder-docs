...
For more information on how to customise the menu sections and the left panel please see: [Customize the panel](../content-types/customize/configure-panel.md).
